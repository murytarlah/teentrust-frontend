...
export const BoardOfTrustees = [
	...
	},
	{
		...
		title: 'Member, Board of Trustees',
		about:	'Abdulganiy is an Associate Chattered Accountant of the Institute of Chartered Accountants of Nigeria (ICAN). He was the first Director of Finance of Teens Trust Foundation. He is currently a member of the Board of Trustees of the foundation where he acts as Internal Auditor and Financial Adviser.',
	},
	{
		id: uuid(),
	...
	},
	{
		...
		title: 'Member, Board of Trustees',
		about:'Lateefat is a graduate of Law from University of Lagos. She currently works as a Corporate Lawyer and an Associate Member of the Institute of Chattered Mediators and Conciliators. She is a talented problem solver and works till great results are produced. She is confident, smart, productive and has a good track of legal advisory.\n Lateefat is passionate about women and children.She volunteers for causes relating to women and children support.\n She is currently the Director, Legal Affairs of the foundation.',
	},
];
...
export const pApps = [
	{
		id: uuid(),
		image: '/assets/google-for-nonprofits-twitter.png',
		title: 'Google for NGOs:',
		about:
			'Google is contributing to the success of our activities at Teens Trust Foundation. Google, through Google for NGOs, provides business-suite tech services for our foundation for free in a bid to enhance our corporate communications which is key to our corporate status.',
	},
	{
		id: uuid(),
		image: '/assets/slack-for-nonprofits-twitter.png',
		title: 'Slack for NGOs:',
		about:
			'Slack has enabled the day-to-day running of our foundation’s activities by enhancing corporate connection within various management members and teams of the foundation. The foundation currently has access to premium slack services for free.',
	},
	{
		id: uuid(),
		image: '/assets/kobi.png',
		title: 'Media KOBI:',
		about:
			'Media KOBI is an Administrative Partner of Teens Trust Foundation. In this partnership, Media KOBI provides top-notch professional graphics/UIUX Designs to Teens Trust Foundation at 70% of the actual cost. KOBI gives this discount as a form of the company’s commitment to social responsibility and is regarded as a donor to the foundation.',
	},
	{
		id: uuid(),
		image: '/assets/aimoc 1.png',
		title: 'AIMOC Visuals:',
		about:
			'AIMOC Visuals is in partnership with us for provision of professional graphics design to the foundation at 70% discount and for free in certain instances. AIMOC Visuals manifest its company’s status as a socially responsible firm and gives this discount as a form of donation to the foundation.',
	},
	{
		id: uuid(),
		image: '/assets/techsoup.png',
		title: 'TechSoup Nigeria:',
		about:
			'Techsoup Nigeria is enhancing our vision at Teens Trust Foundation through the provision of access to tech products at huge discounts or for free. With Techsoup support, we are able to access tech services from global tech bodies like Google, Microsoft, Slack amongst others with very less or no pay.',
	},
];